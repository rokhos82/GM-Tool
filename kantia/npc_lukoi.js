...
kantia.template.npcs["Lukoi Berserker, Basic"] = new kantia.template.npc(
	...
	"Lukoi",
	{
		"strength": new kantia.template.npcAttribute("Strength",14,18,18),
		"size": new kantia.template.npcAttribute("Size",14,17,14),
		"agility": new kantia.template.npcAttribute("Agility",8,12,11),
		"reflexes": new kantia.template.npcAttribute("Reflexes",8,10,11),
		"constitution": new kantia.template.npcAttribute("Constitution",13,15,13),
		"fortitude": new kantia.template.npcAttribute("Fortitude",14,18,15),
		"reasoning": new kantia.template.npcAttribute("Reasoning",6,12,7),
		"willpower": new kantia.template.npcAttribute("Willpower",6,12,8),
		"spirit": new kantia.template.npcAttribute("Spirit",6,12,10),
	...
	},
	{
		...
		"Melee": new kantia.template.npcSkill("Melee","agility",10)
	},
	{
	...
	[
		...
		new kantia.template.npcHC("Armor Proficiency",2),
	...
	["Hard Leather Cuirass","Hard Leather Vambrace","Hard Leather Greaves"],
	{
		"melee": ["Medium Club, 2H","Heavy Club","Battle Axe, 2H","Great Axe","Footman's Pick, 2H","Greatsword","Wood Axe","Pick-Axe"],
		"ranged": []
	},
	"",
