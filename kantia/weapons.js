...
kantia.weapons.melee = {
	...
	"Battle Axe, 1H": {
		...
		damage: {
			avg: 7,
			text: "1d10 + 2",
			roll: function() { kantia.func.d10(1) + 2; }
		}
	},
	"Battle Axe, 2H": {
		difficulty: {
	...
	"Footman's Pick, 1H": {
		...
		damage: {
			avg: 8,
			text: "2d6 + 1",
			roll: function() { kantia.func.d6(2) + 1; }
		}
	},
	"Footman's Pick, 2H": {
		difficulty: {
	...
	"Medium Club, 1H": {
		...
		damage: {
			avg: 4,
			text: "1d8",
			roll: function() { kantia.func.d8(1); }
		}
	},
	"Medium Club, 2H": {
		difficulty: {
	...
	"Heavy Club": {
		...
		damage: {
			avg: 7,
			text: "1d8 + 3",
			roll: function() { kantia.func.d8(1) + 3; }
		}
	},
	"Greatsword": {
		difficulty: {
		...
		damage: {
			avg: 9,
			text: "2d8",
			roll: function() { kantia.func.d8(2); }
		}
	},
	"Wood Axe": {
		difficulty: {
	...
	"Pick-Axe": {
		...
		damage: {
			avg: 10,
			text: "2d6 + 3",
			roll: function() { kantia.func.d6(2) + 3; }
		}
	}
};
