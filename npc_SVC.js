GM.npcSVC = function(dat,parent) {
	...
	this.mainframe.addHandler("updateArmor","weapons",this.updateWeapons,this,[]);
...
//
// -------------------------------------------------------------------------------------------------
GM.npcSVC.prototype.getInitiaitve = function() {
	return this.dat.attributes.reflexes.score;
};
...
//
// -------------------------------------------------------------------------------------------------
GM.npcSVC.prototype.getAttribute = function(attr) {
	return this.dat.attributes[attr];
};
...
//
// -------------------------------------------------------------------------------------------------
GM.npcSVC.prototype.getMask = function(token) {
	return this.dat.masks[token];
};
...
GM.npcSVC.prototype.addArmor = function(dat) {
	GM.debug.log("CALL: GM.npcSVC.addArmor","Adding armor to the NPC",2);
	var index = dat.index;
	var slot = dat.slot;
...
GM.npcSVC.prototype.removeArmor = function(slot) {
	GM.debug.log("CALL: GM.npcSVC.removeArmor","Removing armor from NPC",2);
